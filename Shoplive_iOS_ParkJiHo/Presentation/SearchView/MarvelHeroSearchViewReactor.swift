...
final class MarvelHeroSearchViewReactor: Reactor {
    ...
    enum Mutation {
        ...
        case setSearchResponse(HeroSearch)
    }
    ...
    func reduce(state: State, mutation: Mutation) -> State {
        ...
        case .setSearchResponse(let heroSearch):
            state.heroSearch = .init(with: heroSearch)
            
            state.heroCellReactors = state.heroSearch?.heros.map {
...
extension MarvelHeroSearchViewReactor {
    private func searchRequest() -> Observable<Mutation> {
        do {
            let heroSearchDTO = try JSONDecoder().decode(HeroSearchDTO.self, from: MockJSONResponse.data)
            return .just(.setSearchResponse(heroSearchDTO.toDomain()))
    ...
    "results": [
      {
        ...
        "urls": [
          {
            "type": "detail",
            "url": "http://marvel.com/characters/74/3-d_man?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "wiki",
            "url": "http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          }
        ]
      },
      {
        ...
        "urls": [
          {
            "type": "detail",
            "url": "http://marvel.com/characters/76/a-bomb?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1017100/a-bomb_has?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          }
        ]
      },
      {
        ...
        "urls": [
          {
            "type": "detail",
            "url": "http://marvel.com/characters/77/aim.?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "wiki",
            "url": "http://marvel.com/universe/A.I.M.?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1009144/aim.?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          }
        ]
      },
      {
        ...
        "urls": [
          {
            "type": "detail",
            "url": "http://marvel.com/characters/2809/aaron_stack?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1010699/aaron_stack?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          }
        ]
      },
      {
        ...
        "urls": [
          {
            "type": "detail",
            "url": "http://marvel.com/characters/81/abomination?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "wiki",
            "url": "http://marvel.com/universe/Abomination?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1009146/abomination_emil_blonsky?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          }
        ]
      },
      {
        ...
        "urls": [
          ...
          {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1016823/abomination_ultimate?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          }
        ]
      },
      {
        ...
        "urls": [
          {
            "type": "detail",
            "url": "http://marvel.com/characters/84/absorbing_man?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "wiki",
            "url": "http://marvel.com/universe/Absorbing_Man?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1009148/absorbing_man?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          }
        ]
      },
      {
        ...
        "urls": [
          {
            "type": "detail",
            "url": "http://marvel.com/characters/85/abyss?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "wiki",
            "url": "http://marvel.com/universe/Abyss_(alien)?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1009149/abyss?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          }
        ]
      },
      {
        ...
        "urls": [
          ...
          {
            "type": "wiki",
            "url": "http://marvel.com/universe/Abyss_(Age_of_Apocalypse)?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1010903/abyss_age_of_apocalypse?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          }
        ]
      },
      {
        ...
        "urls": [
          {
            "type": "detail",
            "url": "http://marvel.com/characters/2902/adam_destine?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "wiki",
            "url": "http://marvel.com/universe/Destine,_Adam?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          },
          {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1011266/adam_destine?utm_campaign=apiRef&utm_source=337cfce469368c616af460374cdb33aa"
          }
        ]
      }
    ]
